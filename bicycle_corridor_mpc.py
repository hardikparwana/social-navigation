...
alpha_cbf_nominal_fixed = 2.0#1.0#0.9            # blue
...
humans.X[0,0] = -2.3; humans.X[1,0] = -0.5;
humans.X[0,1] = -2.3; humans.X[1,1] = -0.8#-1.0;
humans.X[0,2] = -2.1; humans.X[1,2] = 2.0;
humans.X[0,3] = -2.5; humans.X[1,3] = 2.0;

humans.goals[0,0] =  4.0; humans.goals[1,0] = -0.5;
humans.goals[0,1] =  4.0; humans.goals[1,1] = -0.8#-1.0;
humans.goals[0,2] = -2.1; humans.goals[1,2] = -0.9;
humans.goals[0,3] =  -2.5; humans.goals[1,3] = -0.9;
