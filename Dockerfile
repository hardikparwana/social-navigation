...
RUN python3.11 -m pip install numpy==1.26.4 matplotlib
RUN python3.11 -m pip install --upgrade "jax[cuda11_pip]==0.4.25" -f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html jaxlib
RUN python3.11 -m pip install matplotlib==3.7.1 pillow==9.5.0 kiwisolver==1.4.4 polytope
RUN python3.11 -m pip install cvxpy casadi cvxpylayers
