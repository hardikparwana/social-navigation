...
robot_social_state = np.array([ robot.X[0,0], robot.X[1,0], 0, 0 , goal[0,0], goal[1,0]]).reshape(1,-1)
...
# with writer.saving(fig1, 'Videos/DU_fs_humans_obstacles_v3.mp4', 100): 
    while t < tf:
        ...
        robot_social_state = np.array([ robot.X[0,0], robot.X[1,0], 0, 0 , goal[0,0], goal[1,0]])
